<?php
  ...
  class ctr_Alimentos {
    ...
    public function registrar_alimento($nombre,$puntoReorden,$cantidad,$cantidadPedido,$tipoMedida){
      return $this->postdata->insertar_alimento($nombre,$puntoReorden,$cantidad,$cantidadPedido,$tipoMedida);
    }
    ...
    public function actualizar_alimento($id,$nombre,$puntoReorden,$cantidad,$cantidadPedido,$tipoMedida){
        return $this->postdata->actualizar_alimento($id,$nombre,$puntoReorden,$cantidad,$cantidadPedido,$tipoMedida);
    }
  ...
  if(isset($_POST['key'])){
    ...
    if($_POST['key']=='registrar_alimento'){
      ...
      $ctr_Alimentos->registrar_alimento($nombre,$puntoReorden,$cantidad,$cantidadPedido,$tipoMedida);
    }
    if($_POST['key']=='actualizar_alimento'){
      ...
      $cantidadPedido = $_POST['alimento_cantidadPedido'];
      $tipoMedida = $_POST['alimento_tipoMedida'];
      $ctr_Alimentos->actualizar_alimento($id,$nombre,$puntoReorden,$cantidad,$cantidadPedido,$tipoMedida);
    }
